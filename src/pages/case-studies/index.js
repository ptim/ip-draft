      ...
      <div className="slab">
        <div className="container">
          ...
          <div className="case-study">
            ...
            <p>Find out more here and read the science publication here. </p>

            <img src={imgLiteracy} width={600} alt="Literacy structural equation model" />
            <a href={pdfLiteracy}><FaPdf /></a>
          </div>
          ...
          <div className="case-study">
            ...
            <p>
              Find out more{' '}
              <a href="http://box5182.temp.domains/~interri2/wp-content/uploads/2017/11/InterplayPoster3_Literacy_19Oct2016.pdf">here</a>{' '}
              and read the science publication{' '}
              <a href="https://link.springer.com/article/10.1007%252Fs10671-017-9217-z&amp;sa=D&amp;ust=1529130503901000">here</a>.
            </p>

            <img src={imgEmployment} width={600} alt="Employment structural equation model" />
            <a href={pdfEmployment}><FaPdf /></a>
          </div>
